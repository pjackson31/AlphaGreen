...
#takes an input trading bot and a finance instance
#generates orignial object of the finance environment columns with the positions the trading bot takes 
#returns positions and the resulting strategy performance
